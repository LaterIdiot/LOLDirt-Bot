...
async function command(message, sentMsg, args, embedTitle) {
    ...
    let playerStats = {
        basic: {
            networkLevel: Math.floor(
                Math.sqrt(12.25 + 0.0008 * networkExp) - 2.5
            ),
            ...
            skywarsLevel: skywars
                ? skywars.skywars_experience
                    ...
                    : 0
                : 0,
            skywarsKDR: ![Infinity, NaN, 0].includes(
                    ...
                    ? ![Infinity, NaN, 0].includes(
                          ((player.stats.UHC.kills || 0) +
                              ...
                              ((player.stats.UHC.deaths || 0) +
                                  ...
                                  (player.stats.UHC["deaths_red vs blue"] ||
                                      0) +
                                  (player.stats.UHC["deaths_no diamonds"] ||
                                      0) +
                                  (player.stats.UHC["deaths_vanilla doubles"] ||
                                      0) +
                        ...
                        ? Number(
                              (
                                  ((player.stats.UHC.kills || 0) +
                                      (player.stats.UHC.kills_solo || 0) +
                                      (player.stats.UHC["kills_red vs blue"] ||
                                          0) +
                                      (player.stats.UHC["kills_no diamonds"] ||
                                          0) +
                                      (player.stats.UHC[
                                          "kills_vanilla doubles"
                                      ] || 0) +
                                      (player.stats.UHC.kills_brawl || 0) +
                                      (player.stats.UHC["kills_solo brawl"] ||
                                          0) +
                                      (player.stats.UHC["kills_duo brawl"] ||
                                          0)) /
                                  ((player.stats.UHC.deaths || 0) +
                                      (player.stats.UHC.deaths_solo || 0) +
                                      (player.stats.UHC["deaths_red vs blue"] ||
                                      ...
                                      (player.stats.UHC["deaths_no diamonds"] ||
                                          0) +
                                      (player.stats.UHC[
                                          "deaths_vanilla doubles"
                                      ] || 0) +
                                      (player.stats.UHC.deaths_brawl || 0) +
                                      (player.stats.UHC["deaths_solo brawl"] ||
                                          0) +
                                      (player.stats.UHC["deaths_duo brawl"] ||
                                          0))
                              ).toFixed(2)
                          )
                        : 0
        ...
        classic: {
            wins: player.stats
                ? (player.stats.VampireZ
                  ...
                  (player.stats.Paintball
                      ? player.stats.Paintball.wins || 0
                      : 0) +
                  (player.stats.Arena ? player.stats.Arena.wins || 0 : 0) +
                  (player.stats.Walls ? player.stats.Walls.wins || 0 : 0) +
                  (player.stats.GingerBread
                      ? player.stats.GingerBread.wins || 0
                      : 0)
                : 0,
        },
        arcade: {
    ...
    playerStats.minor = {
        ...
        skywarsWLR: skywars
            ? ![Infinity, NaN, 0].includes(
                ...
                ? Number(
                      ((skywars.wins || 0) / (skywars.losses || 0)).toFixed(2)
                  )
                : 0
            : 0,
    ...
    const totalRequirementsMet = {
        ...
        major: Object.values(requirementMet.major).includes("✔ ")
            ...
            : "`❌`",
        minor:
            Object.values(requirementMet.minor).filter((x) => x === "✔ ")
                .length >= 2
                ? "`✔` "
                : "`❌`",
    };
